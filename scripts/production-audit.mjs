...
pkg.version==='59.0.0'?ok.push('package version 59.0.0'):fail.push(`package version ${pkg.version}`);
...
gradle.includes('versionName "59.0.0"')?ok.push('Android versionName 59.0.0'):fail.push('Android versionName stale');
gradle.includes('versionCode 590000')?ok.push('Android versionCode 590000'):fail.push('Android versionCode stale');

console.log('CloserFlow V59 production audit');
