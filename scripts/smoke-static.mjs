...
gradle.includes('versionName "67.0.0"')?pass('Android versionName'):fail('Android versionName mismatch');
gradle.includes('versionCode 670000')?pass('Android versionCode'):fail('Android versionCode mismatch');
...
console.log(`CloserFlow V67 static smoke test`);
