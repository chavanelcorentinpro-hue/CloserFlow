...
export function MorePage(){const {resetDemo}=useAppData();return <><div className="page-title"><div><p className="eyebrow">OUTILS</p><h1>Plus</h1></div></div><div className="more-grid">
 ...
 <Link className="menu-card v53-menu" to="/project-margin-v53"><Gauge/><div><strong>CloserFlow 53 · Marge chantier réelle</strong><small>Matière, heures, déplacement, sous-traitance et bénéfice</small></div></Link>
 <Link className="menu-card v52-menu" to="/invoice-stock-v52"><PackageMinus/><div><strong>CloserFlow 52 · Sortie stock & marge</strong><small>Facture client, coût matière réel et marge brute</small></div></Link>
 <Link className="menu-card v51-menu" to="/supplier-prices-v51"><History/><div><strong>CloserFlow 51 · Prix fournisseurs</strong><small>Historique des coûts réels et détection des hausses</small></div></Link>
 <Link className="menu-card v50-menu" to="/purchase-orders-v50"><ClipboardCheck/><div><strong>CloserFlow 50 · Bons de commande</strong><small>Validation, commande, réception et suivi fournisseur</small></div></Link>
 <Link className="menu-card v49-menu" to="/smart-procurement-v49"><ShoppingCart/><div><strong>CloserFlow 49 · Smart Procurement</strong><small>Besoins chantier, stock, achats urgents et budget fournisseur</small></div></Link>
 <Link className="menu-card v48-menu" to="/auto-planning-v48"><CalendarDays/><div><strong>CloserFlow 48 · Planning automatique</strong><small>Affectation, charge, conflits et recalcul des retards</small></div></Link>
 <Link className="menu-card v33-menu" to="/data-health-v33"><DatabaseZap/><div><strong>CloserFlow 33 · Data Health</strong><small>Doublons, références cassées, données B2B et sécurité avant facturation</small></div></Link>
 ...
 <Link className="menu-card cloud-menu v34-menu" to="/cloud"><Cloud/><div><strong>CloserFlow 34 · Cloud multi-appareils</strong><small>Révisions, conflits, appareils fiables et restauration sécurisée</small></div></Link>
